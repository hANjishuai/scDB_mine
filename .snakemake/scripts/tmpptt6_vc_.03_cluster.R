...
snakemake <- Snakemake(
    input = list('result_out/02_scRNA_Qc2Sct/Adult_BoneMarrow/seurat_SCT.Rdata', "seurat_path" = 'result_out/02_scRNA_Qc2Sct/Adult_BoneMarrow/seurat_SCT.Rdata'),
    output = list('result_out/03_cluster/Adult_BoneMarrow/seurat_cluster.Rdata', "seurat_rdata" = 'result_out/03_cluster/Adult_BoneMarrow/seurat_cluster.Rdata'),
    params = list('orig.ident', 'result_out/03_cluster/Adult_BoneMarrow', 'figure_out/03_cluster/Adult_BoneMarrow', 0.3, "orig_ident" = 'orig.ident', "result_out_dir" = 'result_out/03_cluster/Adult_BoneMarrow', "figure_out_dir" = 'figure_out/03_cluster/Adult_BoneMarrow', "cluster_resolution" = 0.3),
    wildcards = list('Adult_BoneMarrow', "tissue_all" = 'Adult_BoneMarrow'),
    threads = 1,
    log = list(),
