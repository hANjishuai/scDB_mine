...
snakemake <- Snakemake(
    input = list('result_out/02_scRNA_Qc2Sct/Adult_Spleen/seurat_SCT.Rdata', "seurat_path" = 'result_out/02_scRNA_Qc2Sct/Adult_Spleen/seurat_SCT.Rdata'),
    output = list('result_out/03_cluster/Adult_Spleen/seurat_cluster.Rdata', "seurat_rdata" = 'result_out/03_cluster/Adult_Spleen/seurat_cluster.Rdata'),
    params = list('orig.ident', 'result_out/03_cluster/Adult_Spleen', 'figure_out/03_cluster/Adult_Spleen', 0.3, "orig_ident" = 'orig.ident', "result_out_dir" = 'result_out/03_cluster/Adult_Spleen', "figure_out_dir" = 'figure_out/03_cluster/Adult_Spleen', "cluster_resolution" = 0.3),
    wildcards = list('Adult_Spleen', "tissue_all" = 'Adult_Spleen'),
    threads = 1,
    log = list(),
