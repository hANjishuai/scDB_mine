...
snakemake <- Snakemake(
    input = list('data/Adult_BoneMarrow', "rawdatadir" = 'data/Adult_BoneMarrow'),
    output = list('figure_out/01_rawdata_merge/Adult_BoneMarrow/integrated.pdf', 'result_out/01_rawdata_merge/Adult_BoneMarrow/seurat_raw.Rdata', "integrated_pdf" = 'figure_out/01_rawdata_merge/Adult_BoneMarrow/integrated.pdf', "seurat_rdata" = 'result_out/01_rawdata_merge/Adult_BoneMarrow/seurat_raw.Rdata'),
    params = list('B1_Adult_BoneMarrow', 'human', "projectname" = 'B1_Adult_BoneMarrow', "species" = 'human'),
    wildcards = list('Adult_BoneMarrow', "tissue_non10x" = 'Adult_BoneMarrow'),
    threads = 1,
    log = list(),
    resources = list('tmpdir', "tmpdir" = '/tmp'),
    config = list("tissue" = 'Adult_PeritonealCavity', "input01" = list("rawdatadir" = 'data/{tissue}'), "params01" = list("projectname" = 'B1_{tissue}', "samples" = c('HC_1', 'HC_2'), "species" = 'human'), "output01" = list("integrated_pdf" = 'figure_out/01_rawdata_merge/{tissue}/integrated.pdf', "seurat_rdata" = 'result_out/01_rawdata_merge/{tissue}/seurat_raw.Rdata'), "tissue_non10x" = c('Adult_BoneMarrow', 'Adult_PeripheralBlood', 'Adult_Spleen'), "input01_non" = list("rawdatadir" = 'data/{tissue_non10x}'), "params01_non" = list("projectname_prefix" = 'B1_', "species" = 'human'), "output01_non" = list("integrated_pdf" = 'figure_out/01_rawdata_merge/{tissue_non10x}/integrated.pdf', "seurat_rdata" = 'result_out/01_rawdata_merge/{tissue_non10x}/seurat_raw.Rdata')),
