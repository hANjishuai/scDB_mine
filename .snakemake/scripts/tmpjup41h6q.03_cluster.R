...
snakemake <- Snakemake(
    input = list('result_out/02_scRNA_Qc2Sct/Adult_PeripheralBlood/seurat_SCT.Rdata', "seurat_path" = 'result_out/02_scRNA_Qc2Sct/Adult_PeripheralBlood/seurat_SCT.Rdata'),
    output = list('result_out/03_cluster/Adult_PeripheralBlood/seurat_cluster.Rdata', "seurat_rdata" = 'result_out/03_cluster/Adult_PeripheralBlood/seurat_cluster.Rdata'),
    params = list('orig.ident', 'result_out/03_cluster/Adult_PeripheralBlood', 'figure_out/03_cluster/Adult_PeripheralBlood', 0.3, "orig_ident" = 'orig.ident', "result_out_dir" = 'result_out/03_cluster/Adult_PeripheralBlood', "figure_out_dir" = 'figure_out/03_cluster/Adult_PeripheralBlood', "cluster_resolution" = 0.3),
    wildcards = list('Adult_PeripheralBlood', "tissue_all" = 'Adult_PeripheralBlood'),
    threads = 1,
    log = list(),
...
run_harmony_clustering <- function(seurat_obj, pcs, orig_ident) {
  ...
  # Harmony整合
  if(seq_along(unique(seurat_obj$orig.ident))>1){
...
run_cluster_pipeline <- function(seurat_path, 
  ...
  # 7-8. 标记基因分析
  markers <- identify_markers(seuratdata,figure_out_dir)
